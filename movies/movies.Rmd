...
Only showing movies with a minimal score of `r min.score`, given that more recent years have more lower score movies (I see more modern movies than old movies). And I still have dozens of movies to see from the 70s and hundreds from the 1950s and 1960s.
...
Let's see how many great films (score at least 9) each decade produced,
...
And masterpieces (score of at least 9.5) per decade,
...
legend(8, 180, rev(c('7+','7.5+','8+','8.5+','9+','9.5+')), 
