...
Showing movies with a minimal rating of `r min.score`. I still have ~20 movies to watch from 1970-2020, but there are hundreds to see from the 1950s and 1960s. Before exploring the 1960s, I'm trying to consolidate movies ratings from the last 50 years. Anyway, here are the wish-lists for the previous two decades:
