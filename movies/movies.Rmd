...
Showing movies with a minimal rating of `r min.score`. I still have some movies to watch from 1970-2020, but there are hundreds to see from the 1950s and 1960s. Before exploring the 1960s, I'm trying to consolidate movies ratings from the last 50 years. Anyway, here are the wish-lists for the previous two decades:
...
```{r, fig.width=15, echo=FALSE, eval=TRUE}
df %>% 
...
legend(8.75, 180, rev(c('7+','7.5+','8+','8.5+','9+','9.5+')), 
