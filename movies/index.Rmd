...
Showing movies with a minimal rating of `r min.score+1` (blue) and the rest (orange). The list of movies I want to see from 1960-1988 and 2000-2022 is (somewhat) complete. My current goal is to do the same from the remaining years up to the end of the 1990s. *Then* I will move to the 1950s.
...
<script>
  function showCityName() { 
    let url = "https://www.imdb.com/search/title/?title_type=feature&view=simple&sort=num_votes,desc";
...
<form name='imdb' onsubmit="return false"> 
   genres: <input type="text" id="genres"     name="genre"  size="15"/> <font size=2>(e.g., horror,sci-fi,!animation)</font>
  <br>min rating: <input type="text" id="rating"     name="min_rating" value="7.5" size="5"/>
  <br>min votes: <input type="text" id="min_votes"  name="min_votes"  value="1000"  size="5"/>
  <br>date: from <input type="text" id="start_date" name="start_date" value="2021-01-01" size="10"/> to <input type="text" id="end_date"   name="end_date"   value="2023-12-31" size="10"/>
  <br><a href="https://help.imdb.com/article/contribution/other-submission-guides/country-codes/G99K4LFRMSC37DCN#" target='_blank'>countries:</a>
  <input type="text" id="countries"  name="countries"  value="!pk,!bd,!in,!tr"  size="15"/> 
  <a href="https://www.loc.gov/standards/iso639-2/php/code_list.php" target='_blank'>
  language:</a> <input type="text" id="language"  name="language"  value="" size="10"/> 
  <br>keywords: <input type="text" id="keywords"  name="keywords"  value="" size="10"/> <font size=2>(e.g., superhero,!marvel)</font>
  <br>just my movies: <input type="checkbox" id="mymovies" name="mymovies" />
  <br><input type="submit" value="Search 🎥" onclick="showCityName()" /> <font size=2>[<a href="https://www.imdb.com/search/title/" target='_blank'>advanced search</a>]</font>
</form>
<hr/>