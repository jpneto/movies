...
Showing movies with a minimal rating of `r min.score` (blue) and the rest (orange). The list of movies I want to see from 1960-1973 and from 2000-2022 is (somewhat) complete. My current goal is to do the same from the remaining 1970s to the end of the 1990s. *Then* I will move to the 1950s.
