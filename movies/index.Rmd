...
Showing movies with a minimal rating of `r min.score` (blue) and the rest (orange). The list of movies I want to see from 1960-1985 and 2000-2022 is (somewhat) complete. My current goal is to do the same from the remaining years up to the end of the 1990s. *Then* I will move to the 1950s.
...
<form name='imdb' onsubmit="return false"> 
    <label>Search movies at IMDB </label>
    <input type="submit" value="🎥" onclick="showCityName()" />
  <br>genres:     <input type="text" id="genres"     name="genre"  size="15"/> (e.g., horror,sci-fi,!animation)
  ...
  <br>start date: <input type="text" id="start_date" name="start_date" value="2021-01-01" size="10"/>
      end date:   <input type="text" id="end_date"   name="end_date"   value="2023-12-31" size="10"/>
  ...
  <a href="https://www.loc.gov/standards/iso639-2/php/code_list.php" target='_blank'>language</a>
  <input type="text" id="language"  name="language"  value="" size="10"/> 
</form>
